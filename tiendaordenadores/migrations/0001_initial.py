# Generated by Django 5.1.2 on 2025-01-14 09:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placabase', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tiendaordenadores.placabase')),
                ('grafica_procesadores', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='procesadores_reverse', to='tiendaordenadores.procesador')),
            ],
        ),
        migrations.CreateModel(
